    ...
    <table class="table table-striped table-hover">
      ...
      <tbody>
        ...
        <tr class="<?php echo $usuario["baja_usuario"]!= 0 ? "table-danger" :"";?>">
            ...
            <a href="/users/<?php echo $usuario["baja_usuario"] !== 0 ? "baja" : "alta"?>/<?php echo $usuario["id_usuario"];?>"><i class="<?php echo $usuario["baja_usuario"] != 0 ? "" : "bi bi-person-fill-check"?>"></i></a></td>
        </tr>
          <?php endforeach;?>
      </tbody>
    </table>
